...
const cardData = [
  {
    ...
    label: '',
    image: 'https://images.unsplash.com/photo-1551434678-e076c223a692?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=80',
    alt: 'Build demonstration showing agent builder interface'
  },
  {
    color: '#060010',
    title: 'Test',
    ...
    label: '',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=80',
    alt: 'Test demonstration showing testing interface'
  },
  {
    color: '#060010',
    title: 'Deploy',
    ...
    label: '',
    image: 'https://images.unsplash.com/photo-1559526324-4b87b5e36e44?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=80',
    alt: 'Deploy demonstration showing deployment options'
  },
  {
    color: '#060010',
    title: 'Monitor',
    ...
    label: '',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&h=800&fit=crop&crop=entropy&auto=format&q=80',
    alt: 'Monitor demonstration showing analytics dashboard'
  }
];
...
const useMobileDetection = () => {
  ...
  useEffect(() => {
    const checkMobile = () => {
      ...
      if (mobile && MOBILE_PERFORMANCE_MODE) {
                  ...
                  {card.image && (
                    <div className="card__image">
                      <img 
                        src={card.image} 
                        alt={card.alt} 
                        className="w-full h-48 md:h-56 lg:h-64 object-cover rounded-lg mt-4 opacity-80 hover:opacity-100 transition-opacity duration-300"
                        loading="lazy"
                      />
                    </div>
                  )}
